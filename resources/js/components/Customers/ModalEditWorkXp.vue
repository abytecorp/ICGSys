            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="myLargeModalLabel">Experiencia laboral en {{ workInformation.bs_name }}</h4>
                                                ...
                                                <div class="sl-right">
                                                    ...
                                                    <form class="orm-control-line m-t-40 row">
                                                        <div class="form-group col-md-12 m-t-20">            
                                                                    <FloatingLabel
                                                                        :config="{label: '', hasError: err.montly_income, hasClearButton: false }">
...
export default {
    ...
    methods : {
        ...
        getWorkExpById(){
                console.log(this.work_infomation_id)
            let url = `/api/${this.work_infomation_id}/get-work-information-by-id`;
                axios.get(url).then(response =>{
